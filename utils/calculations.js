export const calculateUsage = (current, previous) => {
  if (!previous) return 0;
  return current.value - previous.value;
};

export const calculateBill = (usage, tariffs) => {
  let bill = 0;
...
export const getMonthStats = (readings, tariffs) => {
...
export const getConsumptionAlerts = (readings, t) => {
